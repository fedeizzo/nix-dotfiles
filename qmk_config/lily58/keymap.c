...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_CAPS,KC_Z,KC_X,KC_C,KC_D,KC_V,LCTL(KC_T),LCTL(KC_TAB),KC_K,KC_H,KC_COMMA,KC_DOT,KC_SLSH,KC_LSFT,
    KC_NO,LT(_NAV, KC_ESC),LGUI_T(KC_SPC),SFT_T(KC_TAB),LCTL_T(KC_ENT),LT(_NUM, KC_BSPC),KC_LALT,LGUI(KC_TAB)
  ),
  [_NUM] = LAYOUT(
    ...
    KC_NO,KC_GRV,KC_1,KC_2,KC_3,KC_BSLS,KC_NO,KC_NO,KC_PIPE,KC_HASH,KC_AT,KC_EXLM,KC_TILD,TO(_QWERTY),
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LSFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_NO,KC_NO,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLSH,TO(_BASE),
    KC_LGUI,KC_LSFT,KC_SPC,KC_LALT,KC_ENT,KC_TRNS,KC_NO,KC_NO
  )
};
