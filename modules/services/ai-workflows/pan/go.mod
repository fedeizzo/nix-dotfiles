...
require (
	...
	github.com/Cidan/lunchmoney-go v0.0.0-20260615030158-fcc8c7d1ec69
	...
	github.com/vectorize-io/hindsight/hindsight-clients/go v0.0.0-20260619143022-ee81c65e4b9a
