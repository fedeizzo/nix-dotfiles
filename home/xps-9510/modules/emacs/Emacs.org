...
#+begin_src emacs-lisp
  ...
  (use-package notmuch
    :config
    (general-nmap :keymaps 'notmuch-search-mode-map "d" 'fi/notmuch-show-delete)
    (setq
    ...
    (setq notmuch-init-file "~/.config/notmuch/default/config"
          ...
          notmuch-saved-searches '((:name "fedeizzo" :query "to:federico.izzo99@gmail.com and tag:inbox" :key "f")
