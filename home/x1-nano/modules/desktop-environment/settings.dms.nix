...

{
  ...
  session = {
    ...
    weatherLocation = "Paris, France métropolitaine";
    weatherCoordinates = "48.8534951,2.3483915";
    pinnedApps = [ ];
    barPinnedApps = [ ];
    ...
    vpnLastConnected = "ab4ef203-59fb-4036-8cf9-627283987896";
    deviceMaxVolumes = { };
